...
struct CapabilityPayloadConfig {
  ...
  uint32_t host_proof_timeout_ms = 0;
  uint32_t host_proof_ok_total = 0;
  uint32_t host_replay_total = 0;
  uint32_t host_proof_max_gap_ms = 0;
  uint32_t host_proof_mismatch_total = 0;
  uint32_t host_proof_timeout_total = 0;
