...
static constexpr uint16_t kControlIslandHealthPayloadLen = 324;
static constexpr uint8_t kControlIslandHealthSchema = 2;
...
static constexpr uint16_t kControlIslandHealthM7PublishMaxGapOffset = 320;
