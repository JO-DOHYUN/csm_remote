...
static constexpr uint16_t kControlIslandHealthPayloadLen = 328;
static constexpr uint8_t kControlIslandHealthSchema = 3;
...
static constexpr uint16_t kControlIslandHealthReserved93Offset = 93;
static constexpr uint16_t kControlIslandHealthFdcanStateOffset = 94;
static constexpr uint16_t kControlIslandHealthReserved95Offset = 95;
...
static constexpr uint16_t kControlIslandHealthActivationEpochOffset = 324;
