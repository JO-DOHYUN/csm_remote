...
## Authority to Read
Git identity, verification policy, affected authority and exact contract/test tool.
...
The affected level in `docs/verification/VERIFICATION_POLICY_KO.md`; build never substitutes for HIL.
